...
import { navMenuItems, socialLinks, crossNavLink } from "@/lib/immigration-data";
import { MagneticButton } from "@/components/motion";

export default function ImmigrationHeaderNavigation() {
        ...
        <div className="container">
          <div className="header-top-inner">
            <div className="header-top-left">
              ...
              <a href="mailto:info@chaseglobalimmigration.ca" className="header-contact-link">
                <i className="fas fa-envelope" /> info@chaseglobalimmigration.ca
              </a>
            </div>
      ...
      <div className="header-main-bar">
        <div className="container">
          <div className="header-main-inner">
            <Link href="/immigration" className="header-logo">
              <Image
              ...
              <div className="header-logo-wordmark">
                ...
                <span className="header-logo-sub">Immigration</span>
              </div>
            </Link>
                    ...
                    {item.children && openDropdown === item.label && (
                      <ul className="dropdown-menu">
                        {item.children.map((child) => (
                          <li key={child.label}>
                            <Link href={child.href} className="dropdown-link">{child.label}</Link>
                          </li>
                        ))}
                      </ul>
                    )}
            ...
            <div className="header-actions">
              ...
              <MagneticButton>
                <Link href="/immigration/contact" className="header-cta-btn">
                  Free Assessment
                </Link>
              </MagneticButton>
              <button
